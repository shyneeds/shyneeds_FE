      ...
      <Wrapper>
        <Nav>
          <TopUl>
                ...
                <SubWrapper_theme>
                  <SubNav_second>
                    <SubUl_first_theme>
                      <SubBox>
                        <SubLi_first>
                          <Link to="/subPage">문화탐방</Link>
                        </SubLi_first>
                      </SubBox>

                      <SubBox>
                        <SubLi_first>
                          <Link to="/subPage">골프여행</Link>
                        </SubLi_first>
                      ...
                      <SubBox>
                        <SubLi_first>
                          <Link to="/subPage">휴양지</Link>
                        </SubLi_first>
                      </SubBox>

                      <SubBox>
                        <SubLi_first>
                          <Link to="/subPage">트레킹</Link>
                        </SubLi_first>
                      </SubBox>

                      <SubBox>
                        <SubLi_first>
                          <Link to="/subPage">성지순례</Link>
                        </SubLi_first>
                      </SubBox>

                      <SubBox>
                        <SubLi_first>
                          <Link to="/subPage">볼론투어</Link>
                        </SubLi_first>
                      </SubBox>
                    </SubUl_first_theme>
                  </SubNav_second>
            ...
            >
              <Link to="/subPage">커뮤니티</Link>
              {communityOpen && (
                <SubWrapper>
                  <SubNav>
                    <SubUl_first>
                      <SubLi_first>
                        <Link to="/subPage">여행후기</Link>
                      </SubLi_first>
                      <SubLi_first>
                        <Link to="/subPage">게시판</Link>
                      </SubLi_first>
                    </SubUl_first>
                  </SubNav>
                </SubWrapper>
